...
const httpPort = 8080;
const printerURL = '10.0.0.1';
const printerPort = '8883';
const printerSN = 'INSERT SERIAL NUMBER HERE';
const printerAccessCode = 'INSERT ACCESS CODE HERE';


const consoleLogging = false;
const defaultCFG = false; // If using the configs above enable
...
if (defaultCFG != true) {
  fs.readFile("config.json", "utf-8", (err, Data) => {
    ...
    try {
      ...
      printerSN = Json["PrinterSN"]
      printerAccessCode = Json["PrinterAccessCode"]
